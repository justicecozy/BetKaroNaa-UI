     ...
     for(let i = length -1; i >0; i--){
      ...
      if(betType == 0 && Object.keys(this.low).length == 0) {
       ...
       var totalSupplyDisAgrr = await diagreeInstance.totalSupply();
        ...
        this.low['agree'] = totalSupplyAgrr.toNumber()
        this.low['disagree'] = totalSupplyDisAgrr.toNumber()
       ...
       var totalSupplyDisAgrr = await diagreeInstance.totalSupply();
        ...
        this.medium['agree'] = totalSupplyAgrr.toNumber()
        this.medium['disagree'] = totalSupplyDisAgrr.toNumber()
       ...
       var totalSupplyDisAgrr = await diagreeInstance.totalSupply();
        ...
        this.high['agree'] = totalSupplyAgrr.toNumber()
        this.high['disagree'] = totalSupplyDisAgrr.toNumber()
